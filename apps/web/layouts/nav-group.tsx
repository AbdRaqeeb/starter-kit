...
import { NavCollapsible, type NavGroup, NavItem, NavLink } from '@/types/nav';
        ...
        <SidebarGroup>
            ...
            <SidebarMenu>
                {items.map((item) => {
                    ...
                    if (!item.items) return <SidebarMenuLink key={key} item={item} href={''} />;

                    if (state === 'collapsed') return <SidebarMenuCollapsedDropdown key={key} item={item} href={''} />;
